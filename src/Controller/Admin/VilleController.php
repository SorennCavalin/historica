...
class VilleController extends AbstractController
{
    ...
    public function new(Request $request, VilleRepository $villeRepository): Response
    {
        ...
        if ($form->isSubmitted() && $form->isValid()) {
            ...
            return $this->redirectToRoute('app_admin_ville_index', [], Response::HTTP_SEE_OTHER);
        }
    ...
    #[Route('/{id}', name: 'app_admin_ville_show', methods: ['GET'])]
    ...
    #[Route('/{id}', name: 'app_admin_ville_delete', methods: ['POST'])]
