 ...
 */
final class Version20220919081716 extends AbstractMigration
{
    ...
    public function up(Schema $schema): void
    {
        ...
        $this->addSql('CREATE TABLE event (id INT AUTO_INCREMENT NOT NULL, age_id INT NOT NULL, contenu LONGTEXT NOT NULL COMMENT \'(DC2Type:json)\', INDEX IDX_3BAE0AA7CC80CD12 (age_id), PRIMARY KEY(id)) DEFAULT CHARACTER SET utf8mb4 COLLATE `utf8mb4_unicode_ci` ENGINE = InnoDB');
